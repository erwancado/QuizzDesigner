 ...
 */
final class Version20200321152710 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, theme_id INT NOT NULL, filename VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, difficulte INT NOT NULL, est_ordonne TINYINT(1) NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_A412FA92A76ED395 (user_id), INDEX IDX_A412FA9259027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
