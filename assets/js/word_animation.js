window.onload = function(argument) {
    ...
    var lyric = "Sport/History/Animals/Food/Music/Europe/Christmas/Football/Movies/Sciences/Harry Potter/Antartic/Health/Economy/General culture/Mathematics/Monuments/\n" +
        "Celebrities";
    var words = {};
    var words_attr = [];
    string_handle(lyric);
